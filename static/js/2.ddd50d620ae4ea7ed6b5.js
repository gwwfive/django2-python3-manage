...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_env__ = __webpack_require__(86);
...
var update = __webpack_require__(188)("24ad6d9e", content, true);
...
if (!window.Quill) {
  window.Quill = __webpack_require__(258);
}
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'quill-editor',
  data: function data() {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("1b0419a8", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("24aa2835", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("fdd7165e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("35476e20", content, true);
...
var quill = __webpack_require__(258)
var quillEditor = __webpack_require__(322)
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_quill_editor__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_image_extend_module__ = __webpack_require__(507);




__WEBPACK_IMPORTED_MODULE_0_vue_quill_editor__["Quill"].register('modules/ImageExtend', __WEBPACK_IMPORTED_MODULE_1_quill_image_extend_module__["a" /* ImageExtend */]);
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { quillEditor: __WEBPACK_IMPORTED_MODULE_0_vue_quill_editor__["quillEditor"] },
    data: function data() {
        return {
            content: '',
            ...
            editorOption: {
                modules: {
                    ...
                    toolbar: {
                        container: __WEBPACK_IMPORTED_MODULE_1_quill_image_extend_module__["b" /* container */],
                        handlers: {
                            'image': function image() {
                                __WEBPACK_IMPORTED_MODULE_1_quill_image_extend_module__["c" /* QuillWatch */].emit(this.quill.id);
                            }
                        }
                    }
                }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_headTop__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__api_getData__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_env__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_quillEditor__ = __webpack_require__(510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_quillEditor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_quillEditor__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            baseUrl: __WEBPACK_IMPORTED_MODULE_5__config_env__["a" /* baseUrl */],
    ...
    components: {
        quillEditor: __WEBPACK_IMPORTED_MODULE_6__components_quillEditor___default.a,
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_getData__["z" /* getCategory */])(_this2.restaurant_id);

                            case 3:
                                result = _context.sent;

                                if (result.status == 1) {
                                    result.category_list.map(function (item, index) {
                                        item.value = index;
                                        item.label = item.name;
                                    });
                                    _this2.categoryForm.categoryList = result.category_list;
                                } else {
                                    console.log(result);
                                }
                                _context.next = 10;
        ...
        addCategoryFun: function addCategoryFun() {
            this.showAddCategory = !this.showAddCategory;
        },
        submitcategoryForm: function submitcategoryForm(categoryForm) {
            var _this3 = this;

            this.$refs[categoryForm].validate(function () {
                var _ref = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default()(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee2(valid) {
                    var params, result;
                        ...
                        while (1) {
                            switch (_context2.prev = _context2.next) {
                                case 0:
                                    ...
                                    params = {
                                        name: _this3.categoryForm.name,
                                        description: _this3.categoryForm.description,
                                        restaurant_id: _this3.restaurant_id
                                    };
                                    _context2.prev = 2;
                                    _context2.next = 5;
                                    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_getData__["A" /* addCategory */])(params);
                                ...
                                case 5:
                                    ...
                                    if (result.status == 1) {
                                        _this3.initData();
                                        _this3.categoryForm.name = '';
                                        _this3.categoryForm.description = '';
                                        _this3.showAddCategory = false;
                                        _this3.$message({
                                            type: 'success',
                                            message: '添加成功'
                                        });
        ...
        addspecs: function addspecs() {
            this.foodForm.specs.push(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, this.specsForm));
        ...
        addFood: function addFood(foodForm) {
            var _this4 = this;

            this.$refs[foodForm].validate(function () {
                var _ref2 = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default()(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee3(valid) {
                    var params, result;
                        ...
                        while (1) {
                            switch (_context3.prev = _context3.next) {
                                case 0:
                                    ...
                                    params = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, _this4.foodForm, {
                                        category_id: _this4.selectValue.id,
                                        restaurant_id: _this4.restaurant_id,
                                        productDetail: _this4.$refs.quillEditor.content
                                    });

                                    console.log(params);
                                    _context3.prev = 3;
                                    _context3.next = 6;
                                    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__api_getData__["B" /* addFood */])(params);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("4d9191f6", content, true);
...
/* harmony export (immutable) */ __webpack_exports__["c"] = QuillWatch;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = container;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('head-top'), _vm._v(" "), _c('el-row', {
  ...
  }, [_vm._v("选择食品种类")]), _vm._v(" "), _c('el-form', {
    ref: "categoryForm",
    staticClass: "form",
    attrs: {
    ...
    attrs: {
      "placeholder": _vm.selectValue.label
    },
    model: {
      value: (_vm.categoryForm.categorySelect),
      callback: function($$v) {
        _vm.$set(_vm.categoryForm, "categorySelect", $$v)
      },
      expression: "categoryForm.categorySelect"
    }
  }, _vm._l((_vm.categoryForm.categoryList), function(item) {
    return _c('el-option', {
      key: item.value,
      attrs: {
        "label": item.label,
    ...
    class: _vm.showAddCategory ? 'showEdit' : ''
  }, [_c('div', {
    staticClass: "add_category"
  }, [_c('el-form-item', {
    attrs: {
      "label": "食品种类",
      "prop": "name"
    ...
    on: {
      "click": function($event) {
        _vm.submitcategoryForm('categoryForm')
      }
    }
  }, [_vm._v("提交")])], 1)], 1)]), _vm._v(" "), _c('div', {
    staticClass: "add_category_button",
    on: {
      "click": _vm.addCategoryFun
    }
  }, [(_vm.showAddCategory) ? _c('i', {
    staticClass: "el-icon-caret-top edit_icon"
  }) : _c('i', {
    ...
    slot: "icon"
  }), _vm._v(" "), _c('span', [_vm._v("添加食品种类")])])], 1), _vm._v(" "), _c('header', {
    staticClass: "form_header"
  }, [_vm._v("添加食品")]), _vm._v(" "), _c('el-form', {
    ref: "foodForm",
    ...
    model: {
      value: (_vm.foodForm.activity),
      callback: function($$v) {
        _vm.$set(_vm.foodForm, "activity", $$v)
      },
  ...
  }, [(_vm.foodForm.image_path) ? _c('img', {
    staticClass: "avatar",
    attrs: {
      "src": _vm.baseImgPath + _vm.foodForm.image_path
    }
  }) : _c('i', {
    ...
    model: {
      value: (_vm.foodForm.attributes),
      callback: function($$v) {
        _vm.$set(_vm.foodForm, "attributes", $$v)
      },
  ...
  }, [_vm._v("多规格")])], 1), _vm._v(" "), (_vm.foodSpecs == 'one') ? _c('el-row', [_c('el-form-item', {
    attrs: {
      "label": "包装费"
    }
  }, [_c('el-input-number', {
    ...
    model: {
      value: (_vm.foodForm.specs[0].packing_fee),
      callback: function($$v) {
        _vm.$set(_vm.foodForm.specs[0], "packing_fee", $$v)
      },
    ...
    model: {
      value: (_vm.foodForm.specs[0].price),
      callback: function($$v) {
        _vm.$set(_vm.foodForm.specs[0], "price", $$v)
      },
    ...
    on: {
      "click": function($event) {
        _vm.addFood('foodForm')
      }
    }
  }, [_vm._v("确认添加食品")])], 1)], 1), _vm._v(" "), _c('el-dialog', {
    attrs: {
      "title": "添加规格"
    },
    model: {
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.$set(_vm.specsForm, "packing_fee", $$v)
      },
